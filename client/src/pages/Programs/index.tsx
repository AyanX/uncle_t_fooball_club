              ...
              {displayed.map((prog, i) => (
                ...
                >
                  <div className={styles.cardImg}>
                    <BlurImage
                      src={prog.image}
                      blur_image={prog.blur_image}
                      alt={prog.title}
                    />
                    <div className={styles.imgOverlay} />
                    <div className={styles.iconBadge}>{getIcon(prog.icon)}</div>
                  </div>
        ...
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaText}>
              Your partnership or donation helps us scale these programmes and
            ...
            <div className={styles.ctaBtns}>
              ...
              <Link to="/volunteer" className={styles.ctaBtnOutline}>
                Volunteer
              </Link>
            </div>
          </div>
