...
const Home: React.FC = () => {
  const { news, fixtures, programs, gallery, partners, loading,teamName } = useAppContext();
  ...
  return (
    <main>
      ...
      <UpcomingFixtures fixtures={fixtures} loading={loading.fixtures} teamName={teamName} />
