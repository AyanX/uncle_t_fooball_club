...
export const dummyFixtures: Fixture[] = [
  { id: 1, homeTeam: 'Uncle T FC', awayTeam: 'Simba SC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-06', time: '16:00', venue: 'National Main Stadium, prampram  ', competition: 'Ghana Premier League', status: 'upcoming', fans: 0 },
  { id: 2, homeTeam: 'Young Africans', awayTeam: 'Uncle T FC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-13', time: '15:00', venue: 'Benjamin Mkapa Stadium', competition: 'Ghana Premier League', status: 'upcoming', fans: 0 },
  { id: 3, homeTeam: 'Uncle T FC', awayTeam: 'TP Mazembe', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-20', time: '18:00', venue: 'National Main Stadium, prampram  ', competition: 'CAF Champions League', status: 'upcoming', fans: 0 },
  { id: 4, homeTeam: 'Uncle T FC', awayTeam: 'Azam FC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-03-23', time: '16:00', venue: 'National Main Stadium, prampram  ', competition: 'Ghana Premier League', status: 'completed', homeScore: 4, awayScore: 0, fans: 24500 },
  ...
  { id: 7, homeTeam: 'Uncle T FC', awayTeam: 'Al Ahly', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-27', time: '19:00', venue: 'National Main Stadium, prampram  ', competition: 'CAF Champions League', status: 'upcoming', fans: 0 },
];
...
export const dummyPartners: Partner[] = [
  ...
  { id: 3, name: 'Vodacom Ghana', logo: '', blur_image: '', tier: 'gold', website: 'https://example.com', description: 'Powering connectivity for fans and operations across the club.' },
  { id: 4, name: 'Ghana Breweries', logo: '', blur_image: '', tier: 'gold', description: 'Long-standing commercial partner sharing our passion for community.' },
  ...
  { id: 6, name: 'Air Ghana', logo: '', blur_image: '', tier: 'silver', website: 'https://example.com', description: 'Our official travel partner for continental competitions.' },
];
...
export const dummyGallery: GalleryItem[] = [
  ...
  { id: 6, image: 'https://images.pexels.com/photos/209977/pexels-photo-209977.jpeg?auto=compress&cs=tinysrgb&w=800', blur_image: 'https://images.pexels.com/photos/209977/pexels-photo-209977.jpeg?auto=compress&cs=tinysrgb&w=20', caption: 'League Title Celebrations — prampram  ', category: 'Celebrations', featured: false },
...
export const dummyMilestones: Milestone[] = [
  { id: 1, year: '1990', title: 'Club Founded', content: "Uncle T FC was established by a group of football enthusiasts in prampram   with a vision to create Africa's most community-centred club." },
  { id: 2, year: '1998', title: 'First League Title', content: 'Eight years after formation, the club won its first Ghana Premier League title, marking the beginning of a golden era.' },
...
export const dummySocials: SocialInfo = {
  address: 'National Main Stadium, Uhuru Street, prampram  , Ghana',
