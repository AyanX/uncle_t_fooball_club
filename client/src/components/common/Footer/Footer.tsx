...
const LogoMark: React.FC<{ image?: string; blurImage?: string }> = ({
  image,
  blurImage,
}) => {
        ...
        <div className={styles.container}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Born from the slopes of Africa's greatest mountain. Playing for
      ...
      <div className={styles.bottom}>
        <div className={styles.bottomInner}>
          <p className={styles.copy}>
            &copy; {year} Uncle T FC. All rights reserved.
          </p>
