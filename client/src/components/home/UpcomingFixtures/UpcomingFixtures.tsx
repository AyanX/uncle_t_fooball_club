        ...
        {loading ? (
          ...
          <div className={styles.grid}>
                ...
                {upcoming.map((f, i) => (
                  ...
                  >
                    ...
                    <div className={styles.matchup}>
                      <span className={`${styles.team} ${f.homeTeam === 'Kilimanjaro FC' ? styles.us : ''}`}>
                        {f.homeTeam}
                      </span>
                      <span className={styles.vs}>VS</span>
                      <span className={`${styles.team} ${f.awayTeam === 'Kilimanjaro FC' ? styles.us : ''}`}>
                        {f.awayTeam}
                      </span>
                    </div>
            ...
            <div className={styles.col}>
              ...
              <div className={styles.list}>
                {recent.map((f, i) => {
                  const won = (f.homeTeam === 'Kilimanjaro FC' && (f.homeScore ?? 0) > (f.awayScore ?? 0))
                    || (f.awayTeam === 'Kilimanjaro FC' && (f.awayScore ?? 0) > (f.homeScore ?? 0));
