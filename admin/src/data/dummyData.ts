// =============================================================================
// dummyData.ts — All static fallback data for Kilimanjaro FC
...
export const dummyFixtures: Fixture[] = [
  { id: 1, homeTeam: 'Kilimanjaro FC', awayTeam: 'Simba SC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-06', time: '16:00', venue: 'National Main Stadium, Dar es Salaam', competition: 'Tanzania Premier League', status: 'upcoming', fans: 0 },
  { id: 2, homeTeam: 'Young Africans', awayTeam: 'Kilimanjaro FC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-13', time: '15:00', venue: 'Benjamin Mkapa Stadium', competition: 'Tanzania Premier League', status: 'upcoming', fans: 0 },
  { id: 3, homeTeam: 'Kilimanjaro FC', awayTeam: 'TP Mazembe', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-20', time: '18:00', venue: 'National Main Stadium, Dar es Salaam', competition: 'CAF Champions League', status: 'upcoming', fans: 0 },
  { id: 4, homeTeam: 'Kilimanjaro FC', awayTeam: 'Azam FC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-03-23', time: '16:00', venue: 'National Main Stadium, Dar es Salaam', competition: 'Tanzania Premier League', status: 'completed', homeScore: 4, awayScore: 0, fans: 24500 },
  { id: 5, homeTeam: 'Gor Mahia', awayTeam: 'Kilimanjaro FC', homeTeamLogo: '', awayTeamLogo: '', date: '2024-03-16', time: '15:00', venue: 'Kasarani Stadium, Nairobi', competition: 'East African Champions Cup', status: 'completed', homeScore: 1, awayScore: 2, fans: 18200 },
  { id: 6, homeTeam: 'Kilimanjaro FC', awayTeam: 'Nairobi City Stars', homeTeamLogo: '', awayTeamLogo: '', date: '2024-03-09', time: '18:00', venue: 'Amaan Stadium, Zanzibar', competition: 'East African Champions Cup Final', status: 'completed', homeScore: 2, awayScore: 1, fans: 31000 },
  { id: 7, homeTeam: 'Kilimanjaro FC', awayTeam: 'Al Ahly', homeTeamLogo: '', awayTeamLogo: '', date: '2024-04-27', time: '19:00', venue: 'National Main Stadium, Dar es Salaam', competition: 'CAF Champions League', status: 'upcoming', fans: 0 },
];

// --- Programs ---
export const dummyPrograms: Program[] = [
  { id: 1, slug: 'sports', title: 'Sports Academy', tagline: 'Developing the Stars of Tomorrow', description: 'Our structured football academy provides world-class coaching for youth aged 8 to 18.', longDescription: 'Kilimanjaro FC Sports Academy is the cornerstone of our community mission. We offer structured coaching pathways from grassroots to elite levels, working with over 1,200 young players every season.', image: 'https://images.pexels.com/photos/3621104/pexels-photo-3621104.jpeg?auto=compress&cs=tinysrgb&w=800', blur_image: 'https://images.pexels.com/photos/3621104/pexels-photo-3621104.jpeg?auto=compress&cs=tinysrgb&w=20', icon: 'Trophy', color: '#1B4D2E', stats: [{ label: 'Youth Players', value: '1,200+' }, { label: 'Qualified Coaches', value: '48' }, { label: 'Pro Players Produced', value: '12' }, { label: 'Partner Schools', value: '24' }], highlights: ['Full-season structured programmes for ages 8-18', 'Residential academy for elite prospects', 'Partnership with schools across 3 countries', 'Annual national talent identification camps'] },
  { id: 2, slug: 'environment', title: 'Green Goals', tagline: 'Football for a Sustainable Future', description: 'Using the power of football to drive environmental awareness and conservation across East Africa.', longDescription: 'Green Goals is Kilimanjaro FC flagship environmental programme, using the club platform to promote conservation, sustainability, and climate action.', image: 'https://images.pexels.com/photos/1366913/pexels-photo-1366913.jpeg?auto=compress&cs=tinysrgb&w=800', blur_image: 'https://images.pexels.com/photos/1366913/pexels-photo-1366913.jpeg?auto=compress&cs=tinysrgb&w=20', icon: 'Leaf', color: '#2A7044', stats: [{ label: 'Trees Planted', value: '50,000+' }, { label: 'Communities Reached', value: '120' }, { label: 'Clean-up Events', value: '85' }, { label: 'Tonnes of Waste Removed', value: '42' }], highlights: ['Annual Kilimanjaro Tree Planting Festival', 'Zero single-use plastic policy at the stadium', 'Solar panels on training facility rooftops', 'Environmental education in partner schools'] },
...
export const dummyGallery: GalleryItem[] = [
  ...
  { id: 2, image: 'https://images.pexels.com/photos/3148452/pexels-photo-3148452.jpeg?auto=compress&cs=tinysrgb&w=800', blur_image: 'https://images.pexels.com/photos/3148452/pexels-photo-3148452.jpeg?auto=compress&cs=tinysrgb&w=20', caption: 'Training Session — Kilimanjaro FC Academy', category: 'Training', featured: false },
...
export const dummyMilestones: Milestone[] = [
  { id: 1, year: '1990', title: 'Club Founded', content: "Kilimanjaro FC was established by a group of football enthusiasts in Dar es Salaam with a vision to create Africa's most community-centred club." },
  ...
  { id: 4, year: '2012', title: 'New Stadium', content: 'Kilimanjaro FC moved into the refurbished National Main Stadium, boosting capacity and improving the matchday experience.' },
...
export const dummySocials: SocialInfo = {
  ...
  email: 'info@kilimanjaro-fc.com',
  open_hours: '8:00',
  close_hours: '17:00',
  open_day: 'Mon',
  close_day: 'Fri',
  location: 'Dar es Salaam, Tanzania',
  twitter: 'https://twitter.com/kilimanjarofc',
  facebook: 'https://facebook.com/kilimanjarofc',
  instagram: 'https://instagram.com/kilimanjarofc',
  youtube: 'https://youtube.com/kilimanjarofc',
};
